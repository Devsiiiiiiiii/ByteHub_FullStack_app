...
const DBLeftSection = () => {
  return (
    <div className='h-full py-12 flex flex-col bg-lightOverlay backdrop-blr-12 shadow-md min-w-210 w-300 gap-3'>
      <NavLink to={"/dashboard/home"} className="flex items-center justify-start gap-4 px-6">
      <img src={Logo} className="w-12 " alt="" />
      <p className="font-semibold text-xl"> BYTEHUB</p>
    </NavLink>
  ...
  <div className="w-full items-end justify-center flex h-225 mt-auto px-2">
<div className="w-full h-full rounded-md bg-red-400 flex items-center justify-center flex-col gap-3 px-5">
...
<p className="text-base text-white-300 text-center">
