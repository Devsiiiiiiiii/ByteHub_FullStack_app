...
const SliderCard = ({data, index}) => {
  ...
  return (
    <div className='bg-lightOverlay hover:drop-shadow-lg backdrop-md rounded-xl flex items-center justify-between relatice px-4 py-2 w-full md:w-340  md:min-w-350 gap-3'>
