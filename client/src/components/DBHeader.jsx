...
const DBHeader = () => {
  ...
  return (
    <div className='w-full flex items-center justify-between gap-3'>
      <p className="text-2xl text-headingColor "> Welcome to Vendor Dashboard
                {user?.name && (
    ...
    <div className=" flex items-center justify-center gap-4 ">                                        
       ...
       >
        <BsFillBellFill className="text-grey-400 text-xl"/>    
        </motion.div>    
